...
def app():
  ...
  #print(real_time_energy)

  
  datetimes_as_strings = real_time_energy.iloc[:,0]
  #print(datetimes_as_strings)
  ...
  #datetimes_second = datetimes_split.apply(pd.Series)[]
  #datetimes_minute = datetimes_split.apply(pd.Series)[1]
  #datetimes_hour = datetimes_split.apply(pd.Series)[0]
  #print(datetimes_split.apply(pd.Series)[1])
  #real_time_energy["Time"] = datetimes_split.apply(pd.Series)[1]
  print(real_time_energy)
  #print(len(total_energy['Date'].unique().tolist())) 
  #days_filter = datetimes_minute.astype('int')%15 == 0
